        ...
        <>
            <div className="container mx-auto px-4 sm:px-32 py-8">
                ...
                <nav className="flex items-center gap-2 text-sm mb-8">
                    ...
                    <span>/</span>
                    <Link href="#" className="text-gray-500 hover:text-primary disable pointer-events-none">
                        Product-Details
                    </Link>
                    <span>/</span>
            ...
            {/* {relatedProducts && <ProductsCards title={'Related Products'} propProducts={relatedProducts} />} */}
        </>
