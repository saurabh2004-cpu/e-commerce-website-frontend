              ...
              <div className="p-4">
                ...
                <div className="mt-2 space-y-1">
                  <div className="flex items-baseline gap-2">
                    <span className="text-lg font-bold">₹ ₹{Number(product.sellingPrice).toLocaleString('en-IN')}</span>
                    <span className="text-sm text-gray-500 line-through">
                      ₹{Number(calculateDiscount(product?.originalPrice, 17)).toLocaleString('en-IN')}
                    </span>
                  </div>
